  ...
  return (
    <div>
      ...
      <Section
        content={
          <div className="flex flex-col gap-y-10">
            <h1 className="text-5xl font-semibold pb-10">Table of Contents</h1>
            <div className="flex flex-wrap gap-24 md:gap-48 justify-center">
              {tableOfContents.map((entry, index) => (
                <div className="flex flex-col gap-y-4">
                  ...
                  <h2 className="text-2xl font-medium">{entry.title}</h2>
        ...
        content={
          <div className="flex flex-col md:flex-row gap-5">
            <div className="flex-1 flex flex-col gap-y-10">
              <h1 className="text-5xl font-semibold">User Interview</h1>
      ...
      <Section
        content={
          <div className="flex flex-col gap-y-10">
            <h1 className="text-5xl font-semibold">Persona</h1>
            <p className="text-xl">
      ...
      <Section
        content={
          <div className="flex flex-col gap-y-10 text-xl">
            <h1 className="text-5xl font-semibold">Competitive Analysis</h1>
            <p>
      ...
      <Section
        ...
        content={
          <div className="flex flex-col gap-y-10 relative">
            <img src="/pin.svg" className="h-16 absolute -top-8 -left-16" />
            <h1 className="text-7xl font-semibold">How Might We...</h1>
      ...
      <Section
        content={
          <div className="flex flex-col gap-y-10 text-xl">
            <h1 className="text-5xl font-semibold">Feature Ideation</h1>
            <p>
        ...
        content={
          <div className="flex flex-col md:flex-row gap-5">
            <div className="flex-1 flex flex-col gap-10 justify-center">
              <h1 className="text-5xl font-semibold">Sketch</h1>
              <BoldText
        ...
        content={
          <>
            ...
            <div className="pt-36 flex items-center min-h-screen">
              <div className="flex flex-col gap-y-10">
                <h1 className="text-5xl font-semibold">Prototype</h1>
                <p className="text-xl">
